    ...
    <MainLayout>
      ...
      <div className="max-w-[1200px] mx-auto py-16 px-6">
        ...
        <div className="text-center mb-14">
          ...
          <h1 className="text-[46px] font-bold text-gray-900 mt-3 leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          {/* LEFT CARD */}
          <div className="bg-gradient-to-br from-[#EFF6FF] to-[#F8FAFC] rounded-[32px] p-10 relative overflow-hidden">
            ...
            {/* DECOR */}
            <div className="absolute -bottom-12 -right-12 w-56 h-56 bg-blue-200 rounded-full opacity-30"></div>

          </div>

          {/* FORM */}
          <div className="bg-white rounded-[32px] shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-gray-100 p-10">
